...
import { searchCols, IAssignClient, tableColumnsFun } from './Config';
...
const List: React.FC = () => {
  const [tableSource, setTableSource] = useState<{ total: number; list: IAssignClient[] }>({ total: 0, list: [] });
    ...
    <Card className="container" bordered={false}>
      ...
      <div className="mt20">
        <NgTable
          ...
          setRowKey={(record: IAssignClient) => {
