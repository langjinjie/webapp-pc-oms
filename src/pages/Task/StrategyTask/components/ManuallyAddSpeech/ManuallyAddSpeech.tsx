...
export const ManuallyAddSpeech: React.FC<ManuallyAddSpeechProps> = ({ value, onChange }) => {
  // 配置弹框
  ...
  return (
    <>
      <Input placeholder="点击输入文本" value={value} readOnly onClick={() => setSpeechVisible(true)}></Input>
      <NgModal
        title="手工添加话术"
